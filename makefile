...
spark-metal.elf: gpio.o rcc.o util.o startup.o led.o button.o spark-metal.ld $(RUSTOBJS)
	arm-none-eabi-ld -T spark-metal.ld -I$(SELF_DIR)include startup.o gpio.o rcc.o util.o led.o button.o $(RUSTOBJS) -o spark-metal.elf

gpio.o util.o rcc.o led.o button.o: gpio.c rcc.c util.c led.c button.c
	arm-none-eabi-gcc -c -mcpu=cortex-m3 -I$(SELF_DIR)include -g gpio.c rcc.c util.c led.c button.c -mthumb
